...
//     const maxId =
//       currentItemCount > 0 ? Math.max(...initialValues.content.map((item) => item.id)) : 0
//     const newContent = newFiles.map((file, index) => ({
//       id: maxId + index + 1,
//       text: '',
//       type: '',
...
//   // static onDeleteCallback(itemId, setInitialValues, initialValues) {
//   //   console.log("itemId from gallery ",itemId);
//   //   setInitialValues(prevValues => ({
//   //     ...prevValues,
//   //     content: prevValues.content.filter(item => item.id !== itemId)
//   //   }));
//   // }
...
//             <CIcon icon={cilTrash} onClick={() => onDeleteCallback(item.id)} />
//           </div>
//         </div>
//       </>
//     )
